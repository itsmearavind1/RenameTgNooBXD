...
"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me JOin > @Super_botz  ❤️**"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT @super_botz_support "
